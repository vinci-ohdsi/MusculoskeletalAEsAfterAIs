...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (761175,81379,80187,762282,762283,4115164,42872415)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (761175,81379,80187,762282,762283,4115164,42872415)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2005657,4196903,4346304,42735672,42735674,42735673,42735676,42735675,4101039,2006202,2006196,2006180,2006204,2006122,4275569,44793145,2005728,45888216)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2005657,4196903,4346304,42735672,42735674,42735673,42735676,42735675,4101039,2006202,2006196,2006180,2006204,2006122,4275569,44793145,2005728,45888216)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44789602,44789354,44789601,44789353,44789600,4290622)
...
(
  select po.* 
  FROM @cdm_database_schema.PROCEDURE_OCCURRENCE po
JOIN #Codesets codesets on ((po.procedure_source_concept_id = codesets.concept_id and codesets.codeset_id = 28))
) C
JOIN @cdm_database_schema.PERSON P on C.person_id = P.person_id
WHERE YEAR(C.procedure_date) - P.year_of_birth >= 55
AND P.gender_concept_id in (8532)
